 ...
 *         &lt;element name="healthCarePerson" type="{urn:hl7-org:v3}REDS_MT010001UV.Person" minOccurs="0"/>
 *       &lt;/sequence>
...
public class REDSMT010001UVHealthCareProvider {
    ...
    protected CE code;
    @XmlElementRef(name = "healthCarePerson", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
